...
public class Clientes_DF {

    public interface  IDdeviolvercliente{
//en las interface se pone el tipo de dato que va a infresar que es vdevolverusuario

        public void devolverUsuario(Lclientes lclientes); //usuario d emensajeria_Activity //nota2 en as interfaces el dato que se retorna es este
    ...
    private static Clientes_DF clientes_df;
    ...
    public static Clientes_DF getInstance(){

        //si el objeto esta creado retornar su estancia

        if(clientes_df==null) clientes_df= new Clientes_DF();
        return clientes_df;

    }
    private Clientes_DF(){ //inicia la estancia de firebase
        ...
        reference_clientes=database_f.getReference(Constantes.Nodo_clientes);//el nodo esta en constantedes java alli puse el codigo
    ...
    public void  obtenerinformacionDeUsuarioporLLaveUID (final String key, final Clientes_DF.IDdeviolvercliente iDdeviolvercliente){ //se usa en mensajeria.java para obetener la infor del ususario en firebase
        ...
        reference_clientes.child(key).addListenerForSingleValueEvent(new ValueEventListener() { //vamos al hijo osea los que esta dentro de lso nodods
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) { //sse ontubo la informacion
               ...
               Lclientes lclientesd=new  Lclientes(key,clientedata);
                ...
                iDdeviolvercliente.devolverUsuario(lclientesd);
    ...
    public void cliente_nuevo(String key_emisor, Clientes clientes){
